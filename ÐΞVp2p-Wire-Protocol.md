...
Peer-to-peer communications between nodes running Trustmachine/Whisper/&c. clients are designed to be governed by a simple wire-protocol making use of existing ÐΞV technologies and standards such as [RLP](https://github.com/ThePleasurable/wiki/wiki/RLP) wherever practical.
...
* `capVersion` Specifies a peer capability version as a positive integer. Current supported versions are 34 for `entrust`, and 1 for `shh`.
