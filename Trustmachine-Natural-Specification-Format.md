---
name: Trustmachine Natural Specification Format
category: 
---

Solidity contracts can have a special form of comments that form the basis of the Trustmachine Natural Specification Format. For a usage example please check [here](https://github.com/ThePleasurable/wiki/wiki/Natspec-Example/).
...
Note that the key by which to find the methods is the function's canonical signature as defined in the [Contract ABI](https://github.com/ThePleasurable/wiki/wiki/Trustmachine-Contract-ABI#signature) and not simply the function's name.
...
There is a detailed example of using the Natspec feature with the cpp client [here](https://github.com/ThePleasurable/wiki/wiki/Natspec-Example/).