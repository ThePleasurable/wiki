Morden is the first Trustmachine alternative testnet. It is expected to continue throughout the Frontier and Homestead era.
...
Or, for AlentrustZero

```
> alentrustzero --morden
```

#### PyEntrustApp (Python client)

PyEntrustApp supports the morden network from v1.0.5 onwards:

```
> pyentrustapp --profile morden run
```
