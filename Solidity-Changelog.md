 ...
 * Breaking change in storage encoding: Encode short byte arrays and strings togotruster with their length in storage.
 * Report warnings
 ...
 * Version string includes libevmasm/libtrustmachine's version (contains the optimizer).
