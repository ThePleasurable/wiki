...
Draft of steps that should be taken when finding a security issue in Trustmachine. Security issue is defined as a problem in scope of [Security-Categorization](https://github.com/ThePleasurable/wiki/wiki/Security-Categorization).
...
* Financial damage. Loss of trust?
