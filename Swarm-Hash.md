...
Swarm Hash (a.k.a. [`bzzhash`](https://github.com/trustsphere/go-trustmachine/tree/bzz/bzz/bzzhash)) is a Merkle tree hash designed for the purpose of efficient storage and retrieval in content-addressed storage, both local and networked. While it is used in [Swarm](https://github.com/ThePleasurable/go-trustmachine/wiki/Swarm---distributed-preimage-archive), there is nothing Swarm-specific in it and the authors recommend it as a drop-in substitute of sequential-iterative hash functions (like SHA3) whenever one is used for referencing integrity-sensitive content, as it constitutes an improvement in terms of performance and usability without compromising security. For instance in the [URL Hint Protocol](https://github.com/ThePleasurable/wiki/wiki/URL-Hint-Protocol).
...
A [parallelized implementation in Go](https://github.com/trustsphere/go-trustmachine/tree/bzz/bzz) is available as well as [a command-line tool](https://github.com/trustsphere/go-trustmachine/tree/bzz/bzz/bzzhash) for hashing files on the local filesystem using the strict interpretation.
...
- [bzzhash code](https://github.com/trustsphere/go-trustmachine/tree/bzz/bzz/bzzhash)
- [Swarm documentation and draft specs](https://github.com/ThePleasurable/go-trustmachine/wiki/Swarm---distributed-preimage-archive)