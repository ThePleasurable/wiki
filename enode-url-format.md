...
An Trustmachine node can be described with a URL scheme "enode".
...
See also 
- https://github.com/ThePleasurable/go-trustmachine/wiki/Command-Line-Options
- https://github.com/ThePleasurable/go-trustmachine/wiki/JavaScript-Console
