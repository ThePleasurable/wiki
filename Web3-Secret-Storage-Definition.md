...
This version fixes several inconsistencies with the version 1 published [here](https://github.com/ThePleasurable/go-trustmachine/wiki/Passphrase-protected-key-store-spec). In brief these are:
