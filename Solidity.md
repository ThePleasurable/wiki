...
From the syntax, it will feel mostly similar to somentrusting between JavaScript and C++ but with a number of  additions to make it suitable for writing contracts within Trustmachine. Language additions include:
